...
class AppointmentController {
  ...
  async store(req, res) {
    ...
    await Notification.create({
      content: `New appointment of ${user.name} para ${formattedDate}.`,
      user: provider_id
    });
  ...
  async delete(req, res) {
    const appointment = await Appointment.findByPk(req.paramns.id, {
      include: [
        {
          model: User,
          as: "provider",
    ...
    await Mail.sendMail({
      ...
      text: "You have a cancelled appointment."
    });
